                            ...
                            <div class="grid grid-cols-1 gap-6 lg:grid-cols-6">
                                ...
                                <x-forms.form-field class="lg:col-span-2">
                                    ...
                                    <x-forms.input id="name" name="name" type="text"
                                        value="{{ old('name') }}" placeholder="Enter Subscription Name" />
                                    <x-forms.input-error key="name" />
                                </x-forms.form-field>

                                <x-forms.form-field class="lg:col-span-3">
                                    <x-forms.label for="subscription-type">Subscription Type</x-forms.label>
                                    ...
                                    <x-forms.form-field class="lg:col-span-2">
                                        ...
                                        <x-forms.input id="per_amount" name="per_amount" type="text"
                                            value="{{ old('per_amount') }}" placeholder="Per Installment Price" />
                                    ...
                                    <x-forms.form-field class="cursor-pointer lg:col-span-2" id="select-date-container">
                                        <x-forms.label for="start">Installment Start</x-forms.label>
                                        <x-forms.input id="start" name="start" type="text"
                                            value="{{ old('start') }}"
                                        ...
                                        @endphp
                                        <div class="hidden bg-gray-600 w-96" id="monthly-picker">
