      ...
      <div class="relative w-full px-4 lg:w-9/12">
        <div
          ...
          <div class="p-6 pb-12 max-h-[500px] overflow-y-auto">
            <!-- Enable scroll -->
            <form action="{{ route('subscriptions.store', $organization->id) }}"
              method="POST">
              @csrf
              ...
              <div class="grid grid-cols-1 gap-6 lg:grid-cols-6">
                ...
                <x-forms.form-field class="lg:col-span-3">
                  ...
                  <x-forms.form-select id="subscription-type" name="type">
                  ...
                  <x-forms.form-field class="lg:col-span-2">
                    ...
                    <x-forms.input id="total" name="total" type="text"
                      value="{{ old('total') }}"
                  ...
                  <x-forms.form-field class="lg:col-span-2">
                    <x-forms.label for="per_amount">Per Installment Amount
                      price</x-forms.label>
                    <x-forms.input id="per_amount" name="per_amount" type="text"
                      value="{{ old('per_amount') }}"
                  ...
                  <x-forms.form-field class="lg:col-span-2">
                    ...
                    <x-forms.input id="penalty_amount" name="penalty_amount"
                      type="text" value="{{ old('penalty_amount') }}"
                      placeholder="Per Installment Price" />
                  ...
                  <x-forms.form-field class="cursor-pointer lg:col-span-2"
                    ...
                    <x-forms.label for="start">Installment
                      Start</x-forms.label>
                    <x-forms.input class="bg-gray-100 cursor-pointer" id="start"
                      name="start" type="text" value="{{ old('start') }}"
                      placeholder="Select to specify Installment start" readonly />
                    ...
                    @endphp
                    <div
                      class="hidden bg-white border border-gray-300 rounded-md shadow-lg w-96"
                      id="monthly-picker">
                      <div class="grid grid-cols-3 gap-3 p-6">
                        @foreach ($months as $key => $value)
                          <p class="px-5 py-2 text-center text-black transition-all border border-gray-200 rounded-md cursor-pointer hover:bg-gray-200 hover:border-gray-400"
                    ...
                    @endphp
                    <div class="hidden bg-gray-600 w-96" id="yearly-picker">
                      <div class="grid grid-cols-3 gap-3 p-6">
