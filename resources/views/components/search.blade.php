<form action="{{ route("organizations.index")}}" method="GET" class="hidden lg:block ">
    ...
    <div class="relative mt-1 lg:w-96">
        ...
        <input type="text" name="query" value="{{ request('query') }}" id="topbar-search" {{ $attributes->merge(["class"=>"bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500
