<div id="approve-user-modal" class="fixed inset-0 z-50 flex items-center justify-center hidden">
    <div class="justify-between p-4 bg-white dark:bg-gray-800">
        ...
        <div class="flex justify-end">
            ...
            <form action="#" method="POST" id="approve-user-form" method="POST">
                @csrf

                <x-buttons.button type="submit" value="{{ $actionConfirmBtn }}"
