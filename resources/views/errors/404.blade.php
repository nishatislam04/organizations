  ...
  <main class="bg-gray-50 dark:bg-gray-900">
    ...
    <div class="flex flex-col items-center justify-center h-screen px-6 mx-auto xl:px-0 dark:bg-gray-900">
      <div class="block md:max-w-md">
        <img src="{{ Vite::asset("resources/images/illustrations/404.svg")}}" alt="astronaut image">
      </div>
      <div class="text-center xl:max-w-4xl">
        <h1 class="mb-3 text-2xl font-bold leading-tight text-gray-900 sm:text-4xl lg:text-5xl dark:text-white">Page not
          found</h1>
        <p class="mb-5 text-base font-normal text-gray-500 md:text-lg dark:text-gray-400">Oops! Looks like you followed
