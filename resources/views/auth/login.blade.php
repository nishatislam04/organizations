    ...
    <div class="flex flex-col items-center justify-center px-6 pt-8 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900">
      ...
      <div class="w-full max-w-xl p-6 space-y-8 bg-white rounded-lg shadow sm:p-8 dark:bg-gray-800">
        ...
        <form class="mt-8 space-y-7" action="{{ route("auth.login")}}" method="POST">
          ...
          <div>
            <label for="username" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">username or
              email</label>
          ...
          <div class="flex items-center">
            ...
            <label for="checked-checkbox" class="text-sm font-medium text-gray-900 ms-2 dark:text-gray-300">Remember
              Me</label>
          </div>
          <button type="submit"
