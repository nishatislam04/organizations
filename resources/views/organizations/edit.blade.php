        ...
        <div
          ...
          <div
            ...
            <h3 class="text-xl font-semibold dark:text-white">
              Update <span
                class="text-4xl font-normal">{{ $organization->name }}
              </span> informations
            </h3>
              ...
              <div class="grid grid-cols-6 gap-6 ">
                ...
                <x-forms.form-field>
                  ...
                  <x-forms.input id="name" name="name"
                    type="text" value="{{ $organization->name }}"
                ...
                <x-forms.form-field>
                  ...
                  <x-forms.input id="max_members" name="max_members"
                    type="text" value="{{ $organization->max_members }}"
                    placeholder="Maximum member can join" />
                </x-forms.form-field>

                <x-buttons.button
                  class="text-white text-sm px-5 py-2.5 text-center "
