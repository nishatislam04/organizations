              ...
              <div class="rounded-lg shadow dark:bg-gray-900 h-80">
                ...
                <div class="grid w-full h-full grid-cols-12 p-12">
                  ...
                  <div class="col-start-1 col-end-8">
                    ...
                    <p class="mb-2 text-sm text-gray-500 dark:text-gray-400">ID: {{ $organization->organizationId }}</p>

                    <!-- Max Members -->
                    <div class="flex gap-2 my-2 mt-5">
                      <p class="font-medium text-gray-400">Max Members:</p>
                      <p class="text-lg font-semibold text-gray-500 dark:text-gray-300">{{ $organization->max_members }}
                      </p>
                    </div>
                    ...
                    <div class="flex items-baseline gap-2">
                      ...
                      <p class="text-lg font-semibold text-gray-500 dark:text-gray-300">{{ $organization->username }}
                      </p>
                    </div>
                    ...
                    <div class="flex items-baseline gap-2 mb-4">
                      ...
                      <p class="text-lg font-semibold text-gray-500 dark:text-gray-300">
                    ...
                    <div>
                      ...
                      <p class="text-sm text-gray-500 dark:text-gray-400">{{ $organization->subscriptions->count() }}
                        Subscriptions</p>
                    </div>
                  </div>

                  <!-- Right Section: Description -->
                  <div class="flex flex-col col-start-8 col-end-13 gap-4 p-4 rounded-lg dark:bg-gray-800">
