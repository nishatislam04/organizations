        ...
        <div
          ...
          <div class="relative w-full mb-2 h-28">
            ...
            <div class="flex items-center justify-between sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
              ...
              <x-buttons.button :href="route('subscriptions.create', $organization->organizationId)" type="a"
        ...
        <div class="flex flex-col">
          <div class="overflow-x-auto">
            <div class="inline-block min-w-full align-middle">
              <div class="bg-gray-900 rounded-lg shadow h-80">
                ...
                <div class="grid w-full h-full grid-cols-12 p-12">
                  ...
                  <div class="col-start-1 col-end-8">
                    <h2 class="text-2xl font-semibold text-blue-500">{{ $organization->name }}</h2>
                    <p class="mb-2 text-sm text-gray-400">ID: {{ $organization->organizationId }}</p>

                    <!-- Max Members -->
                    <div class="flex gap-2 my-2 mt-5">
                      <p class="font-medium text-gray-400">Max Members:</p>
                      <p class="text-lg font-semibold text-gray-300">{{ $organization->max_members }}</p>
                    </div>

                    <!-- Author -->
                    <div class="flex items-baseline gap-2">
                      <p class="font-medium text-gray-400">Author:</p>
                      <p class="text-lg font-semibold text-gray-300">{{ $organization->username }}</p>
                    </div>
                    ...
                    <!-- Total Subscriptions -->
                    <div>
                      <h3 class="text-lg font-semibold text-blue-500">Total Subscriptions</h3>
                      <p class="text-sm text-gray-400">{{ $organization->subscriptions->count() }} Subscriptions</p>
                    </div>
                  </div>

                  <!-- Right Section: Description -->
                  <div class="flex flex-col col-start-8 col-end-13 gap-4 p-4 bg-gray-800 rounded-lg">
                    <p class="font-medium text-gray-400">Description</p>
                    <p class="text-gray-300">{{ $organization->description }}</p>
                  </div>
                </div>

                <!-- Button to Show All Subscriptions -->
                <x-buttons.button :href="route('subscriptions.index', $organization->organizationId)" type="a"
                  class="absolute bottom-0 px-5 py-3 ml-auto text-sm text-white transform -translate-x-1/2 bg-yellow-500 left-[48%] hover:bg-yellow-600 focus:ring-4 focus:ring-yellow-300 dark:bg-yellow-700 dark:hover:bg-yellow-600 focus:outline-none dark:focus:ring-yellow-800">
